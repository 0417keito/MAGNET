...
from english import g2p as g2p_english
from japanese import g2p as g2p_japanese
from symbols import (
    language_id_map,
...
def g2p(text, order=None):
    ...
    phones, ids = segments_to_phones(segments)
    return phones, ids
...
if __name__ == "__main__":
    ...
    print(clean_text('はかなきおもい.... このトラジディ ナイト'))
    
    phones, ids = g2p('はかなきおもい.... このTragedy Night')
